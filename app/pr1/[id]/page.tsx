...
import { ChevronLeft, Pencil, Printer, Clock, CircleCheck as CheckCircle2, User, Building2, FileText, CalendarDays, CircleAlert as AlertCircle } from 'lucide-react';
        ...
        <div>
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {canUpdatePriority ? (
              ...
              <PriorityBadge priority={pr1.priority} />
            )}
          </div>
      ...
      <div className="space-y-5">
        ...
        <div className="bg-white rounded-[4px] border border-[#D8E2FF] overflow-hidden">
          <div className="px-6 py-4 border-b border-[#D8E2FF] bg-[#F7F9FC] flex items-center justify-between">
            <h2 className="text-xs font-semibold text-[#40527A] uppercase tracking-wide">Request Header</h2>
            <span className="text-xs text-[#BFC7D5]">Form No. PR1-v1</span>
          </div>
          <div className="p-6 grid grid-cols-2 md:grid-cols-3 gap-5">
            ...
            <InfoField icon={Clock} label="Date" value={format(new Date(pr1.created_at), 'MMMM d, yyyy')} />
            <InfoField
              icon={CalendarDays}
              label="Date Required"
        ...
        <div className="bg-white rounded-[4px] border border-[#D8E2FF] overflow-hidden">
          <div className="px-6 py-4 border-b border-[#D8E2FF]">
            <h2 className="text-xs font-semibold text-[#40527A] uppercase tracking-wide">Items Requested</h2>
          </div>
