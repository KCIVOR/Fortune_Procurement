...
export default function ResetPasswordPage() {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-[#F7F9FC]">
        <div className="w-full max-w-md bg-white border border-[#E5EAFF] rounded-lg p-8 shadow-sm text-center">
          ...
          <h1 className="text-lg font-semibold text-[#0F1F3A] mb-2">Reset link issue</h1>
          <p className="text-sm text-[#40527A] mb-6">{linkError}</p>
          <Link href="/forgot-password" className="text-sm font-medium text-[#1E4BFF] hover:underline">
            Request a new reset link
          </Link>
          <p className="text-xs text-[#7A8BA8] mt-4">
  ...
  if (!sessionReady) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-[#F7F9FC]">
        <p className="text-sm text-[#40527A]">Verifying your reset link…</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white lg:bg-gradient-to-br lg:from-[#F7F9FC] lg:to-white flex flex-col justify-center px-4 py-10">
      <div className="w-full max-w-[400px] mx-auto">
        ...
        <h1 className="text-2xl font-bold text-[#0F1F3A] text-center mb-1">Set a new password</h1>
        <p className="text-sm text-[#40527A] text-center mb-8">Choose a strong password for your account.</p>
        ...
        <div className="bg-white rounded-lg border border-[#E5EAFF] p-6 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <label htmlFor="npw" className="block text-sm font-medium text-[#0F1F3A]">
                New password
              </label>
            ...
            <div className="space-y-2">
              <label htmlFor="nconfirm" className="block text-sm font-medium text-[#0F1F3A]">
                Confirm password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#BFC7D5]" />
